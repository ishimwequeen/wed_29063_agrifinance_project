...
CREATE TABLE FARMER_AUDIT_LOG (
    ...
    FARMER_ID VARCHAR2(50),
    STATUS VARCHAR2(20) NOT NULL, -- ALLOWED, DENIED
    REASON VARCHAR2(500),
...
CREATE SEQUENCE HOLIDAY_SEQ START WITH 200 INCREMENT BY 1;

CREATE SEQUENCE AUDIT_LOG_SEQ START WITH 300 INCREMENT BY 1 NOCACHE NOCYCLE;
